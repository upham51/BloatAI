-- Grant admin role to the initial admin user (upham51@gmail.com)
...
BEGIN
  ...
  ELSE
    RAISE WARNING 'User upham51@gmail.com not found in auth.users table. Please ensure the user account exists before running this migration.';
  END IF;
END $$;
